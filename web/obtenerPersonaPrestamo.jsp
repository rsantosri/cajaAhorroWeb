            ...
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 ">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Elija una persona para administrar préstamos</h1>
                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${listaPersonas.lista}" var="persona">
                                                <tr>
                                                    ...
                                                    <td><button type="submit" value="${persona.ClavePersona}" lass="btn btn-outline-primary">Elegir</button></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
